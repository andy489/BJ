...
fetch('https://api.openweathermap.org/data/2.5/weather?q=sofia&appid=' + window.WEATHER_API_KEY)
    .then(data => data.json())
    .then(info => {
...
fetch('https://api.openweathermap.org/data/2.5/weather?q=lasvegas&appid=' + window.WEATHER_API_KEY)
    .then(data => data.json())
    .then(info => {
...
fetch('https://api.openweathermap.org/data/2.5/weather?q=monaco&appid=' + window.WEATHER_API_KEY)
    .then(data => data.json())
    .then(info => {
...
fetch('https://api.openweathermap.org/data/2.5/weather?q=macao&appid=' + window.WEATHER_API_KEY)
    .then(data => data.json())
    .then(info => {
